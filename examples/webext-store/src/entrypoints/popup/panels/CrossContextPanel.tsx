  ...
  return (
    ...
    >
      ...
      <p className="text-[11px] text-slate-500 dark:text-slate-400">
        Leave this tab open and watch the number climb on its own — that write is coming from a
        completely separate execution context (the service worker), not from this component.
      </p>
    </Card>
  );
}
