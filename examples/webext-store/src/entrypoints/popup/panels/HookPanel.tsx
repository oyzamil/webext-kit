...
export function HookPanel() {
	...
	const { value, loading, error, setValue, removeValue } = useStorage(
		heartbeatItem,
		{
			onChange: (newValue, oldValue) =>
				logOnChange(`onChange: ${oldValue} -> ${newValue}`),
		},
	);
	...
	return (
		...
		>
			<div>
				...
				<div className="mt-1 font-bold text-3xl text-indigo-600 dark:text-indigo-400">
					{value}
				</div>
				<Row>
					<Button
